...
public class Validator extends DefaultHandler {
	...
	public String getNamespace() throws Exception {
    	...
    	for(int x=0,size= nodeList.getLength(); x<size; x++) {
	        ...
	        if(namespace == null) doc.renameNode(node, "https://spase-group.org/data/schema", node.getNodeName());
	        namespace = node.getNamespaceURI();
	...
	public InputStream openWellFormedFile(Boolean withMessage) throws Exception {
    	...
    	for(int x=0,size= nodeList.getLength(); x<size; x++) {
	        ...
	        if(namespace == null) {	// No namespace - set to spase
	        	doc.renameNode(node, "https://spase-group.org/data/schema", node.getNodeName());
	        	fixed = true;
	        }
    	}
	...
	public void validate() throws Exception {
		...
		*/
		...
		try {
			...
			// saxParser.setProperty("https://apache.org/xml/properties/schema/external-schemaLocation", "/temp/spase-2_2_2.xsd");
			// saxParser.setProperty("https://apache.org/xml/properties/schema/external-noNamespaceSchemaLocation", "/temp/spase-2_2_2.xsd");
